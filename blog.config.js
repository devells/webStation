...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '19b143d87e6a8070960acedaba10adae',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Devells', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '技术美术', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.devells-art.com/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '技术美术, 渲染', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20250762号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20250762', // 备案查询链接，如果用了萌备等备案请在这里填写 <a href="https://icp.gov.moe/?keyword=20250762" target="_blank">萌ICP备20250762号</a>
